<?php
// Get courses data for course management
$courses = $courses ?? [];
...
<?= $this->section('title') ?>
Course Material Management - ITE311
<?= $this->endSection() ?>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            ...
                            <?php if ($materialsCount > 0): ?>
                            <button class="btn btn-outline-secondary w-100 btn-sm" onclick="viewMaterials(<?= $course['id'] ?>)">
...
function viewMaterials(courseId) {
    // Could expand to show materials for this course
    window.location.href = '<?= base_url('/course/manage/') ?>' + courseId;
}
